  ...
  return (
    <div className="container mx-auto p-8 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg">Lecture notes or recording transcripts for summarization</p>
      ...
      {role === "teacher" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Written notes from the lecture</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Transcribed audio from recordings</p>
            </CardContent>
          </Card>
        </div>
      )}
